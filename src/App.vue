 ...
 <v-app>
  <v-container>
    <v-layout>
      ...
      <v-flex class="ml-5">
        <div>
          <v-btn color="blue">Save me</v-btn>
        </div>
      </v-flex>
    </v-layout>
  </v-container>
